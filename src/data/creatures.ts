...
export const CREATURE_DEFS: Record<string, CreatureDef> = {
  ...
  'Rift Parasite':  { name: 'Rift Parasite',  radius: 11, color: 0xbb33ff, speed: 148, hp: 5,  detection: 330, meleeDmg: 1, ranged: false, rangedDmg: 0, rangedCooldown: 0, voidType: true,  behavior: 'pack',         ingredient: { id: 'rift_spore', name: 'Rift Spore' } },
  ...
  'Void Spawn':     { name: 'Void Spawn',     radius: 11, color: 0x9922dd, speed: 140, hp: 3,  detection: 310, meleeDmg: 1, ranged: false, rangedDmg: 0, rangedCooldown: 0, voidType: true,  behavior: 'pack',         ingredient: { id: 'void_core', name: 'Void Core' } },
};
