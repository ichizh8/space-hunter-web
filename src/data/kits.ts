...
export const KIT_DEFS: Record<string, KitDef> = {
  // Starter tier (Kepler-affordable)
  stim_pack:    { id: 'stim_pack',    name: 'Stim Pack',  icon: 'S', desc: '+4 HP, +15 corruption',       cooldown: 8,  charges: -1, unlockCost: 0,   tierCosts: [0, 80, 200] },
  flash_trap:   { id: 'flash_trap',   name: 'Flash Trap', icon: 'T', desc: 'Stun trap 80px 2s',           cooldown: 0,  charges: 2,  unlockCost: 0,   tierCosts: [0, 100, 250] },
  // Basic tier (late-Kepler / early-Tidal)
  blink_kit:    { id: 'blink_kit',    name: 'Phase Shift', icon: 'B', desc: 'Invulnerable 1.5s, slow enemies 70%', cooldown: 12, charges: -1, unlockCost: 150, tierCosts: [150, 180, 400] },
  chain_kit:    { id: 'chain_kit',    name: 'Chain',       icon: 'C', desc: 'Tether enemy 3s',             cooldown: 12, charges: -1, unlockCost: 200, tierCosts: [200, 200, 450] },
  charge_kit:   { id: 'charge_kit',   name: 'Charge',      icon: 'X', desc: 'Knockback blast 150px',       cooldown: 12, charges: -1, unlockCost: 150, tierCosts: [150, 180, 400] },
  // Advanced tier (Tidal income needed)
  mirage_kit:   { id: 'mirage_kit',   name: 'Mirage',      icon: 'M', desc: 'Decoy draws aggro 6s',        cooldown: 18, charges: -1, unlockCost: 300, tierCosts: [300, 250, 550] },
  turret_kit:   { id: 'turret_kit',   name: 'Turret',      icon: 'R', desc: 'Auto-turret 12s',             cooldown: 20, charges: -1, unlockCost: 280, tierCosts: [280, 220, 500] },
  familiar_kit: { id: 'familiar_kit', name: 'Familiar',    icon: 'F', desc: 'Void familiar, rams enemies', cooldown: 0,  charges: -1, unlockCost: 280, tierCosts: [280, 250, 550] },
  smoke_kit:    { id: 'smoke_kit',    name: 'Smoke',       icon: 'K', desc: 'Smoke screen 150px 6s',       cooldown: 14, charges: -1, unlockCost: 200, tierCosts: [200, 180, 400] },
  // Elite tier (Void Reach income needed)
  anchor_kit:   { id: 'anchor_kit',   name: 'Anchor',      icon: 'A', desc: 'Gravity pull 400px 4s',       cooldown: 20, charges: -1, unlockCost: 400, tierCosts: [400, 350, 700] },
  drone_kit:    { id: 'drone_kit',    name: 'Drone',       icon: 'D', desc: 'Intercepts 1 bullet/4s',      cooldown: 0,  charges: -1, unlockCost: 450, tierCosts: [450, 350, 750] },
  pack_kit:     { id: 'pack_kit',     name: 'Pack',        icon: 'P', desc: 'Summon 2 allies 15s',         cooldown: 25, charges: -1, unlockCost: 400, tierCosts: [400, 350, 700] },
  // Apex tier (Furnace income needed)
  void_surge:   { id: 'void_surge',   name: 'Void Surge',  icon: 'V', desc: 'Spend 20 corr: +80% speed 3s', cooldown: 0, charges: -1, unlockCost: 600, tierCosts: [600, 450, 900] },
  rupture_kit:  { id: 'rupture_kit',  name: 'Rupture',     icon: 'U', desc: 'Detonate corruption bar AOE', cooldown: 0,  charges: -1, unlockCost: 700, tierCosts: [700, 500, 1000] },
};
