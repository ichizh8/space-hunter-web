...
export const WEAPON_DEFS: Record<string, WeaponDef> = {
  sidearm:          { id: 'sidearm',          name: 'Laser Pistol', desc: 'Auto-targets closest enemy', fireRate: 1.2, damage: 3, bulletSpeed: 420, bulletRadius: 4, color: 0x00ffcc, range: 286, pattern: 'laser',       magSize: 12, reloadTime: 1.5 },
