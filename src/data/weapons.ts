...
export const WEAPON_DEFS: Record<string, WeaponDef> = {
  sidearm:          { id: 'sidearm',          name: 'Pistol',   desc: 'Directional semi-auto',     fireRate: 0.75, damage: 2.8, bulletSpeed: 420, bulletRadius: 4, color: 0xffcc00, range: 220, pattern: 'single',      magSize: 12, reloadTime: 1.5 },
